# PSF-IAminy — Etapa 78: Inversa relacional
...
A inversa relacional troca a direção dos pares. Ela só vira função inversa quando a relação original é bijetora.

## Exemplo

- Para `f = {(0,1),(1,2),(2,3)}`, a inversa troca cada par: contém `(3,2)` (porque `f` continha `(2,3)`).
