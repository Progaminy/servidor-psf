# PSF-IAminy — Etapa 120: Complemento de grafo
...
Mesmos vértices, arestas são exatamente as NÃO-arestas do original. O complemento de um grafo completo não tem arestas nenhumas — confirmado.
