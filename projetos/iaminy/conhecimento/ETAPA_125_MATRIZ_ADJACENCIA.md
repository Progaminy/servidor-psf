# PSF-IAminy — Etapa 125: Matriz de adjacência
...
M[i][j]=1 se (vi,vj) é aresta, 0 caso contrário — ponte direta entre grafos (etapa 111) e matrizes (etapa 106), já ambos construídos.
